...
CREATE TABLE USERS(
	user_id SERIAL INT PRIMARY KEY NOT NULL,
	user_firstname TEXT NOT NULL,
	user_lastname INT NOT NULL,
);

CREATE TABLE CATEGORIES(
	category_id SERIAL INT PRIMARY KEY NOT NULL,
	category_name TEXT NOT NULL
);

--users and categories table mapping
CREATE TABLE SUBSCRIPTIONS(
	subscription_id SERIAL INT PRIMARY KEY NOT NULL,
...
CREATE TABLE TOPICS(
	topic_id SERIAL INT PRIMARY KEY NOT NULL,
...
CREATE TABLE QUIZZES(
	quiz_id SERIAL INT PRIMARY KEY NOT NULL,
...
CREATE TABLE QUESTIONS(
	question_id SERIAL INT PRIMARY KEY NOT NULL,
...
CREATE TABLE USERQUIZ(
	userquiz_id SERIAL INT PRIMARY KEY NOT NULL,
...
CREATE TABLE CHALLENGES(
	challenge_id SERIAL INT PRIMARY KEY NOT NULL,
